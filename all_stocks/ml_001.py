...
def calculateTE(arrayList):
    result = []
    l = list(itertools.combinations(arrayList, 2))
    ...
    for array in l:
        ...
        teCalc.setObservations(JArray(JDouble, 1)(array[0]), JArray(JDouble, 1)(array[1]))
